...
export default function Tk(){
    return(
        <div className="flex flex-col w-full h-full font-serif text-lg">
            ...
            <div className="font-serif mx-36 mb-4">
                ...
                <div>
                    ...
                    <ol className="list-decimal list-inside">
                        <li>
                            Membiasakan salam saat datang kesekolah dan bertemu dengan ibu guru,di dalam maupun di luar lingkungan sekolah.
                        </li>
                        <li>
                            Membiasakan salim/cium tangan kepada guru,orang tua dan orang yang lebih tua.
                        </li>
                        <li>
            ...
            <div>
                <h3 className="text-4xl text-left font-bold mb-4">Aktivitas Keseharian</h3>
